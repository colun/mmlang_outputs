// https://atcoder.jp/contests/abc169/submissions/15766609
/* src: (14 lines)
...
int main() {
    N = inputInt();
    A.resize(max((int)A.size(), (int)N)); for(int $1=0; $1<N; ++$1) A[$1] = inputInt128();
    ZERO = 0;
    for(int $1=0; $1<N; ++$1) ZERO += A[$1] == 0;
    if(ZERO) {
        print(0);
        return 0;
    }
