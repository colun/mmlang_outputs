// https://atcoder.jp/contests/agc047/submissions/15796926
/* src: (25 lines)
...
int main() {
    N = inputInt();
    B.resize(max((int)B.size(), (int)N)); for(int $1=0, $e=(0<=N ? N : (int)B.size()+N); $1<$e; ++$1) B[$1] = tuple<int, int>(0, 0);
