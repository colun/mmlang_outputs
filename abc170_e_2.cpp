// https://atcoder.jp/contests/abc170/submissions/15765022
/* src: (21 lines)
...
int main() {
    ...
    S.resize(max((int)S.size(), (int)2e5 + 8)); for(int $1=0; $1<2e5 + 8; ++$1) S[$1] = multiset<int>();
    for(int $1=0; $1<(int)B.size(); ++$1) S[B[$1]].insert(A[$1]);
    R = multiset<int>();
